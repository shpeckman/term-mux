...
Term::Mux::Emitter.define do
  ...
  decset mouse_any_event, mode: 1003
  decset mouse_sgr_pixels, mode: 1016
  decset focus_events, mode: 1004
  decset in_band_resize, mode: 2048
  decset grapheme_clustering, mode: 2033
  decset color_scheme_updates, mode: 2031
  ...
  csi cha(col), final: 'G', defaults: {1}
